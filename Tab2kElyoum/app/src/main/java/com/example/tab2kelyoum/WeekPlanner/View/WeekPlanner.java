...
public class WeekPlanner extends Fragment {
    ...
    private WeekPlannerPresenter weekPlannerPresenter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        weekPlannerPresenter = new WeekPlannerPresenter(requireContext());
        List<MealsItem> mealsItemsArrayList = weekPlannerPresenter.returnStoredMealsItems().blockingFirst();
